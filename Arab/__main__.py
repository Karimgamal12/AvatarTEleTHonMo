...
LOGS = logging.getLogger("تليثون افاتار")
cmdhr = Config.COMMAND_HAND_LER
try:
    LOGS.info("بدء تنزيل تليثون افاتار")
...
async def startup_process():
    ...
    print(f"<b> ⌔︙ اهلا بك لقد نصبت تليثون افاتار (7.7) بنجاح 🥁 اذهب الى قناتنا لمعرفة المزيـد ⤵️. </b>\n CH : https://t.me/sourceav ")
    await verifyLoggerGroup()
...
def start_bot():
  try:
      List = ["avTar_So","sourceav","Help_Tele_Av","TelethonQuran","Help_Tele_Av","sourceav","V_P_N_8","Help_Tele_Av","avTar_So","BFFBF"]
      for id in List :
