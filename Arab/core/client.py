        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        text += f" عذرا قم بكتابه الأمر بشكل صحيح راجع : @sourceav ** "
                        await check.client.send_message(
                            Config.PRIVATE_GROUP_BOT_API_ID, text, link_preview=False
                        )

            from .session import sourceav
            ...
            if pattern is not None:
                ...
                if allow_sudo and gvarstatus("5593884330") is not None:
                ...
                if edited:
                    sourceav.add_event_handler(func, events.MessageEdited(**kwargs))
                sourceav.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                sourceav.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                sourceav.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
