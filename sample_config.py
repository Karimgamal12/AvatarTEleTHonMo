...
class Config(object):
    LOGGER = True
    ALIVE_NAME = os.environ.get("ALIVE_NAME", "@sourceav")
    ...
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/Karimgamal12/Karimgamal12/tree/main")
    ...
    THUMB_IMAGE = os.environ.get("THUMB_IMAGE", "https://graph.org/file/873c09ae4687cc03ccafe.jpg")
